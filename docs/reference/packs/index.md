...
| heliophysics | ontologies | ontology | Space-weather entity vocabulary (geomagnetic storms, solar flares, coronal mass ejections, named geomagnetic/flare indices, geomagnetically induced currents, auroral observations, NOAA severity-scale alerts); extends physical-science-base | none |
...
| non-ionizing-radiation | ontologies | ontology | Non-ionizing EMF exposure entity vocabulary (power-frequency and RF/microwave field quantities including specific absorption rate, regulatory exposure limits, IARC carcinogenicity classifications); extends physical-science-base and clinical-health-base | none |
