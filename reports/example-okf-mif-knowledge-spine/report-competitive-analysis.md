---
slug: reports/example-okf-mif-knowledge-spine/report-competitive-analysis
version: 1
...
```mermaid
quadrantChart
    title Knowledge-spine approaches: Completeness of Vision vs Ability to Execute
    ...
    "OKF+MIF": [0.82, 0.32]
    "RDF/OWL": [0.80, 0.22]
    "OKF (Google Cloud)": [0.45, 0.55]
    "schema.org": [0.42, 0.85]
    "JSON-LD / YAML-LD": [0.48, 0.68]
    "PKM tools": [0.30, 0.72]
    "PROV-O": [0.40, 0.25]
    "SKOS": [0.35, 0.40]
