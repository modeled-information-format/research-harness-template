---
slug: reports/example-okf-mif-knowledge-spine/report-trend-analysis
version: 1
...
```mermaid
xychart-beta
    title "Structured-knowledge addressable market, USD billions (2034 = projection)"
    x-axis ["KM SW 2025", "Ent-KG 2025", "Combined TAM 2025", "Combined TAM 2034 proj"]
...
stateDiagram-v2
    [*] --> NascentSpine2026
    NascentSpine2026 --> LayeredSpineAscendancy: provenance demand persists + standards consolidate + MIF closes distribution gap
    NascentSpine2026 --> OKFMinimalismWins: buyers prefer minimal markdown; MIF fields seen as overhead
    NascentSpine2026 --> IncumbentAbsorption: Google or KG platforms add native provenance + typing
    NascentSpine2026 --> SemanticWebRedux: layered authoring friction stalls adoption
    LayeredSpineAscendancy --> [*]
    OKFMinimalismWins --> [*]
    IncumbentAbsorption --> [*]
    SemanticWebRedux --> [*]
```
