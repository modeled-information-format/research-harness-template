...
created: "2026-06-28T14:10:31Z"
modified: "2026-06-28T14:10:31Z"
temporal:
  "@type": TemporalMetadata
  validFrom: "2026-06-28T14:10:31Z"
  ttl: P6M
  recordedAt: "2026-06-28T14:10:31Z"
provenance:
  '@type': Provenance
...
citations:
  - '@type': Citation
    ...
    citationRole: refutes
    title: a16z 'How 100 Enterprise CIOs Are Building and Buying Gen AI in 2025' - source does not substantiate the specific 76%/50-50 build-vs-buy figure on inspection (only a qualitative shift-to-buying)
    url: https://a16z.com/ai-enterprise-2025/
  - '@type': Citation
    citationType: article
    citationRole: supports
    title: 'JSON-LD Schema Markup for AI Discoverability: Technical Guide 2026 - AgentVisibility.ai'
    url: https://agentvisibility.ai/insights/json-ld-schema-ai-discoverability
  - '@type': Citation
    citationType: article
    citationRole: supports
    title: 'Governing Evolving Memory in LLM Agents: Risks, Mechanisms, and the SSGM Framework — arXiv'
    url: https://arxiv.org/html/2603.11768v1
  - '@type': Citation
    citationType: article
    citationRole: supports
    title: A Decade of Scholarly Research on Open Knowledge Graphs - Research community KG adoption (arXiv)
    url: https://arxiv.org/pdf/2306.13186
  - '@type': Citation
    citationType: article
    citationRole: supports
    title: OWL Reasoners still useable in 2023 (arXiv)
    url: https://arxiv.org/pdf/2309.06888
  - '@type': Citation
    citationType: article
    citationRole: supports
    title: 'Semantic Web: Past, Present, and Future — arXiv 2412.17159'
    url: https://arxiv.org/pdf/2412.17159
  - '@type': Citation
    citationType: article
    citationRole: supports
    title: Semantic Web and Software Agents — A Forgotten Wave of Artificial Intelligence? arXiv 2503.20793
    url: https://arxiv.org/pdf/2503.20793
  - '@type': Citation
    citationType: article
    citationRole: supports
    title: 'PROV-AGENT: Unified Provenance for Tracking AI Agent Interactions in Agentic Workflows (arXiv)'
    url: https://arxiv.org/pdf/2508.02866
  - '@type': Citation
    citationType: article
    citationRole: supports
    title: 'Gartner on Context Graphs: Trends, Capabilities, Setup in 2026 — Atlan'
    url: https://atlan.com/know/gartner-context-graphs/
  - '@type': Citation
    citationType: documentation
    citationRole: supports
    title: 'Ontology vs. Semantic Layer: Differences and schema.org limitations — Atlan'
    url: https://atlan.com/know/ontology-vs-semantic-layer/
  - '@type': Citation
    citationType: documentation
    citationRole: supports
    title: 'RDF vs OWL: Key Differences, Use Cases and Examples Explained - Atlan'
    url: https://atlan.com/know/rdf-vs-owl/
  - '@type': Citation
    citationType: website
    citationRole: supports
    title: Stardog Enterprise Knowledge Graph Platform Pricing (AWS Marketplace)
    url: https://aws.amazon.com/marketplace/pp/prodview-ulfm6fel7xgjq
  - '@type': Citation
    citationType: article
    citationRole: supports
    title: Frictionless Data and FAIR Research Principles - Open Knowledge Foundation Blog
    url: https://blog.okfn.org/2018/08/14/frictionless-data-and-fair-research-principles/
  - '@type': Citation
    citationType: website
    citationRole: supports
    title: Knowledge Management Statistics and Trends in 2025 - Worker productivity costs (CAKE)
    url: https://cake.com/blog/knowledge-management-statistics/
  - '@type': Citation
    citationType: documentation
    citationRole: supports
  ...
  - '@type': Citation
    ...
    url: https://contextandchaos.substack.com/p/ontologies-context-graphs-and-semantic
  - '@type': Citation
    citationType: website
    citationRole: supports
    title: Knowledge Management and Dissemination for Think Tanks (DataCalculus)
    url: https://datacalculus.com/en/blog/think-tanks/program-director/knowledge-management-and-dissemination-for-think-tanks
  - '@type': Citation
    citationType: article
    citationRole: supports
    title: Personal Knowledge Management Software Market Research Report 2034 — DataIntelo
    url: https://dataintelo.com/report/personal-knowledge-management-software-market
  - '@type': Citation
    citationType: documentation
    citationRole: supports
    title: Lessons Learned from the Combined Development of OWL and SHACL — ACM K-CAP 2025
    url: https://dl.acm.org/doi/full/10.1145/3731443.3771340
  - '@type': Citation
    citationType: website
    citationRole: supports
    title: Top Knowledge Management Trends 2026 - Semantic layers and enterprise AI (Enterprise Knowledge)
    url: https://enterprise-knowledge.com/top-knowledge-management-trends-2026/
  - '@type': Citation
    citationType: documentation
    citationRole: supports
    title: LLM Wiki — Karpathy GitHub Gist (April 2026)
  ...
  - '@type': Citation
    citationType: documentation
    citationRole: supports
    title: Frictionless Data Package — GitHub frictionlessdata/datapackage
    url: https://github.com/frictionlessdata/datapackage
  - '@type': Citation
    citationType: documentation
    citationRole: supports
    title: MIF v1.0 — GitHub zircote/MIF
    url: https://github.com/zircote/MIF
  - '@type': Citation
    citationType: documentation
    citationRole: supports
    title: Open Knowledge Format (OKF) — Official Grounding Page
    url: https://groundingpage.com/facts/open-knowledge-format/
  - '@type': Citation
    citationType: documentation
    citationRole: supports
    title: JSON-LD - JSON for Linked Data (Official Site)
    url: https://json-ld.org/
  - '@type': Citation
    citationType: website
    citationRole: supports
    title: Google Cloud Launches Open Knowledge Format Standard - sober adoption assessment (Let's Data Science)
    url: https://letsdatascience.com/news/google-cloud-launches-open-knowledge-format-standard-b9480a66
  - '@type': Citation
    citationType: article
    citationRole: supports
    title: 'From LLMs to Knowledge Graphs: Building Production-Ready Graph Systems in 2025 — Medium'
  ...
  - '@type': Citation
    ...
    url: https://medium.com/@nfigay/beyond-owl-reconsidering-ontologies-in-the-age-of-ai-and-the-semantic-web-4059b519f23d
  - '@type': Citation
    citationType: website
    citationRole: supports
    title: Open-Sourcing the Knowledge Graph Studio under MIT license (Medium/Enterprise RAG)
    url: https://medium.com/enterprise-rag/open-sourcing-the-whyhow-knowledge-graph-studio-powered-by-nosql-edce283fb341
  - '@type': Citation
    citationType: article
    citationRole: supports
    title: 'State of AI Agent Memory 2026: Benchmarks, Architectures & Production Gaps — Mem0'
    url: https://mem0.ai/blog/state-of-ai-agent-memory-2026
  - '@type': Citation
    citationType: documentation
    citationRole: supports
    title: MIF Schema Reference — mif-spec.dev
    url: https://mif-spec.dev/
  - '@type': Citation
    citationType: website
    citationRole: refutes
    title: MIF relationship types (mif-spec.dev) - the core vocabulary is relates-to/derived-from/supersedes/conflicts-with/part-of/implements/uses/created-by/mentioned-in; supports/contradicts/refines/depends-on/updates are not MIF-native core, only custom namespaced
    url: https://mif-spec.dev/specification/relationship-types/
  - '@type': Citation
    citationType: website
    citationRole: supports
    title: 'Open-Source vs SaaS Agent Platforms: Pros & Cons for Enterprises (OneReach.ai)'
    url: https://onereach.ai/blog/open-source-frameworks-vs-saas-agent-platforms/
  - '@type': Citation
    citationType: website
    citationRole: supports
    title: Enterprise Knowledge Graph Buyer's Guide 2026 - Pricing and ROI signals (Promethium)
    url: https://promethium.ai/guides/enterprise-knowledge-graph-buyers-guide-2026/
  - '@type': Citation
    citationType: article
    citationRole: supports
    title: 'Graph RAG Guide 2025: Architecture, Implementation & ROI — Salfati Group'
    url: https://salfati.group/topics/graph-rag
  - '@type': Citation
    citationType: article
    citationRole: supports
    title: 'Obsidian Complete Guide: The Ultimate Markdown Editor for Knowledge Management Revolution 2025 — SmartScope'
    url: https://smartscope.blog/en/obsidian-complete-guide/
  - '@type': Citation
    citationType: article
    citationRole: supports
    title: 'Obsidian vs Logseq 2026: Which PKM Tool Wins? - SoftPicker'
    url: https://softpicker.com/obsidian-vs-logseq/
  - '@type': Citation
    citationType: documentation
    citationRole: supports
    title: Frictionless Data Specifications - Official Home
    url: https://specs.frictionlessdata.io/
  - '@type': Citation
    citationType: documentation
    citationRole: supports
    title: Frictionless Data Package Specification — specs.frictionlessdata.io
    url: https://specs.frictionlessdata.io/data-package/
  - '@type': Citation
    citationType: website
    citationRole: supports
    title: State of Open Data 2025 - FAIR data and open science trends
    url: https://stateofopendata.com/
  - '@type': Citation
    citationType: website
    citationRole: supports
    title: Knowledge Management Software Market Size, Share, Growth, 2034 (Straits Research)
    url: https://straitsresearch.com/report/knowledge-management-software-market
  - '@type': Citation
    citationType: website
    citationRole: supports
    title: 'AI Hallucination Statistics 2026: 50+ Sourced Data Points (Suprmind)'
    url: https://suprmind.ai/hub/insights/ai-hallucination-statistics-research-report-2026/
  - '@type': Citation
    citationType: article
    citationRole: supports
    title: Bi-temporal memory for AI coding agents — git-pinned context that survives context compaction
    url: https://sverklo.com/blog/bi-temporal-memory-for-ai-agents/
  - '@type': Citation
    citationType: article
    citationRole: supports
    title: Google Launches a Universal Format for Karpathy's LLM Wiki — Techstrong.ai
    url: https://techstrong.ai/articles/google-launches-a-universal-format-for-karpathys-llm-wiki/
  - '@type': Citation
    citationType: article
    citationRole: supports
    title: Google Just Standardized Karpathy's LLM Wiki Pattern — The Menon Lab
    url: https://themenonlab.blog/blog/google-okf-open-knowledge-format-karpathy-llm-wiki-standard
  - '@type': Citation
    citationType: website
    citationRole: supports
    title: 'Obsidian Pricing 2026: Plans, Hidden Costs & Cheaper Alternatives (ToolRadar)'
    url: https://toolradar.com/tools/obsidian/pricing
  - '@type': Citation
    citationType: article
    citationRole: supports
    title: 'Agent-to-agent audit trail: provenance for AI ecosystems (TrueScreen)'
    url: https://truescreen.io/articles/agent-to-agent-audit-trail/
  - '@type': Citation
    citationType: article
    citationRole: supports
    title: Personal Knowledge Graphs in Obsidian - Volodymyr Pavlyshyn, Medium
    url: https://volodymyrpavlyshyn.medium.com/personal-knowledge-graphs-in-obsidian-528a0f4584b9
  - '@type': Citation
    citationType: website
    citationRole: supports
    title: Why Bad Knowledge Management Is Killing Your Profits (WikiTeq)
    url: https://wikiteq.com/post/hidden-costs-poor-knowledge-management
  - '@type': Citation
    citationType: website
    citationRole: supports
    title: '2026 Enterprise AI Knowledge Management: AI-native KM market size (Windows Forum/GoSearch)'
    url: https://windowsforum.com/threads/2026-enterprise-ai-knowledge-management-from-search-to-governed-agent-workflows.410816/
  - '@type': Citation
    citationType: website
    citationRole: supports
    title: Open Knowledge Format (OKF) Complete 2026 Guide - ecosystem gaps identified (WitsCode)
    url: https://witscode.com/open-knowledge-format
  - '@type': Citation
    citationType: website
    citationRole: supports
    title: AI-Ready Enterprise Knowledge Graph Market to Reach USD 6,550.0 Million by 2036 (AccessNewswire/FMI)
    url: https://www.accessnewswire.com/newsroom/en/business-and-professional-services/ai-ready-enterprise-knowledge-graph-market-to-reach-usd-6-550.0-1167718
  - '@type': Citation
    citationType: website
    citationRole: supports
    title: Knowledge Management Software Market Size, Industry Share | Forecast 2034 (Fortune Business Insights)
    url: https://www.fortunebusinessinsights.com/knowledge-management-software-market-110376
  - '@type': Citation
    citationType: website
    citationRole: refutes
    title: Gartner Predicts 40% of Enterprise Apps Will Feature Task-Specific AI Agents by 2026, Up from Less Than 5% in 2025 (Gartner Newsroom)
  ...
  - '@type': Citation
    citationType: article
    citationRole: supports
    title: Enterprise Knowledge Graph Market Industry Report 2033 — Grand View Research
    url: https://www.grandviewresearch.com/industry-analysis/enterprise-knowledge-graph-market-report
  - '@type': Citation
    citationType: website
    citationRole: supports
    title: The Cost and Consequence of Institutional Memory Drain (Inc. Magazine)
    url: https://www.inc.com/bethmaser/the-cost-and-consequence-of-institutional-memory-drain/91178504
  - '@type': Citation
    citationType: article
    citationRole: supports
    title: Simple Knowledge Organization System (SKOS) — ISKO Encyclopedia of KO
    url: https://www.isko.org/cyclo/skos.htm
  - '@type': Citation
    citationType: website
    citationRole: supports
    title: Cost of Organizational Knowledge Loss and Countermeasures (Iterators HQ)
    url: https://www.iteratorshq.com/blog/cost-of-organizational-knowledge-loss-and-countermeasures/
  - '@type': Citation
    citationType: website
    citationRole: supports
    title: Why AI Hallucinates in Your Enterprise (and how Context Graphs Fix it) - Kamiwaza
    url: https://www.kamiwaza.ai/insights/why-ai-hallucinates-in-your-enterprise
  - '@type': Citation
    citationType: article
    citationRole: supports
    title: Knowledge Graph Market Worth $9.88 Billion by 2032 — MarketsandMarkets
    url: https://www.marketsandmarkets.com/PressReleases/knowledge-graph.asp
  - '@type': Citation
    citationType: article
    citationRole: supports
    title: Google Cloud Introduces Open Knowledge Format (OKF) — MarkTechPost
  ...
  - '@type': Citation
    citationType: article
    citationRole: supports
    title: 'Knowledge Graph vs Vector Database for RAG: Which Is Best? — Meilisearch'
    url: https://www.meilisearch.com/blog/knowledge-graph-vs-vector-database-for-rag
  - '@type': Citation
    citationType: article
    citationRole: supports
  ...
  - '@type': Citation
    citationType: documentation
    citationRole: supports
    title: A Semantic Approach to Mapping the Provenance Ontology to Basic Formal Ontology — Scientific Data
    url: https://www.nature.com/articles/s41597-025-04580-1
  - '@type': Citation
    citationType: website
    citationRole: supports
    title: Notion vs Obsidian - minimalism as user preference (NotionApps)
    url: https://www.notionapps.com/blog/notion-vs-obsidian-knowledge-productivity-2025
  - '@type': Citation
    citationType: article
    citationRole: supports
    title: 'The Semantic Web: 20 Years and a Handful of Enterprise Knowledge Graphs Later — Ontotext'
    url: https://www.ontotext.com/blog/the-semantic-web-20-years-later/
  - '@type': Citation
    citationType: website
    citationRole: supports
    title: 'Notion vs Obsidian vs Roam Research 2025: Best Note-Taking App for Productivity'
    url: https://www.primeproductiv4.com/blog-articles/notion-vs-obsidian-vs-roam-research-productivity-comparison
  - '@type': Citation
    citationType: article
    citationRole: supports
    title: 'History of Obsidian: Second Brain to AI Knowledge OS — Taskade Blog'
    url: https://www.taskade.com/blog/obsidian-history
  - '@type': Citation
    citationType: website
    citationRole: refutes
    title: AI-Driven Knowledge Management System Market Report (The Business Research Company) - the '$7.71B 2025 / 47.2%' figure traces here, not to GoSearch; cross-firm AI-KM sizing varies widely and the finding's two growth rates do not reconcile
    url: https://www.thebusinessresearchcompany.com/report/ai-driven-knowledge-management-system-global-market-report
  - '@type': Citation
    citationType: website
    citationRole: supports
    title: Neo4j Software Pricing & Plans 2026 (Vendr)
    url: https://www.vendr.com/marketplace/neo4j
  - '@type': Citation
    citationType: documentation
    citationRole: supports
    title: SKOS Simple Knowledge Organization System - W3C Home Page
    url: https://www.w3.org/2004/02/skos/
  - '@type': Citation
    citationType: documentation
    citationRole: supports
    title: RDF & SPARQL Working Group Charter — W3C (April 2025)
    url: https://www.w3.org/2025/04/rdf-star-wg-charter.html
  - '@type': Citation
    citationType: documentation
    citationRole: supports
  ...
  - '@type': Citation
    citationType: documentation
    citationRole: supports
    title: SKOS Simple Knowledge Organization System Primer - W3C Recommendation
    url: https://www.w3.org/TR/skos-primer/
  - '@type': Citation
    citationType: documentation
    citationRole: supports
    title: SKOS Simple Knowledge Organization System Reference — W3C
    url: https://www.w3.org/TR/skos-reference/
  - '@type': Citation
    citationType: documentation
    citationRole: supports
    title: Ontologies and Knowledge Graphs in Industry Community Group — W3C
    url: https://www.w3.org/community/oki/
  - '@type': Citation
    citationType: documentation
    citationRole: supports
    title: YAML-LD — W3C CG Final Report, December 2023
    url: https://www.w3.org/community/reports/json-ld/CG-FINAL-yaml-ld-20231206/
  - '@type': Citation
    citationType: documentation
    citationRole: supports
    title: The PROV-JSONLD Serialization - W3C Member Submission 2024
    url: https://www.w3.org/submissions/2024/SUBM-prov-jsonld-20240825/
  - '@type': Citation
    citationType: article
    citationRole: supports
    title: 'Introducing MIF: Memory Interchange Format — zircote.com (February 2026)'
    url: https://zircote.com/blog/2026/02/introducing-mif-memory-interchange-format/
  - '@type': Citation
    citationType: article
    citationRole: supports
...
Dated 28 June 2026, covering the window since OKF v0.1 shipped on 12 June 2026. Verdict on the layering decision is GO on the evidence: MIF can serve as the typed-modeling, provenance, and temporal spine beneath OKF's git-distributable markdown packaging. The layering is technically feasible through OKF's own extension seam, materially differentiated from prior art, and aimed at a real and growing market. The single open risk is adoption, not capability.

## What's New

- OKF v0.1 shipped on 12 June 2026 and deliberately leaves the spine empty. Google Cloud's vendor-neutral markdown-directory spec requires only a `type` field; it formalizes the LLM-wiki pattern but intentionally omits formal ontology, typed inter-concept links (plain untyped markdown hyperlinks only), and machine-readable provenance (only an optional `log.md` and a `#Citations` prose section). Early traction is real — 5,440 stars and 416 forks within weeks — but it is brand-new and pre-community-governed.
- MIF already supplies exactly that missing spine, and is the more mature half. MIF reached v1.0.0 (Released, stabilized 18 June 2026) and has been public since roughly February 2026, so it predates OKF v0.1; its constraint is distribution and adoption, not spec maturity. It contributes a first-class PROV-O-compatible provenance block (typed source, 0 to 1 confidence, agent identity), bi-temporal tracking with configurable decay versus OKF's single last-changed timestamp, and a formal ontology and entity-typing layer. It also adds typed, directed, strength-weighted relationship edges where OKF has only untyped prose links. Weakened caveat: the specific "nine structural-core types" enumeration is overstated (only four — relates-to, derived-from, supersedes, part-of — are MIF-core; the others are namespaced or custom), but the typed-edge advantage itself holds.
- The layering is mechanically clean and the differentiation survives scrutiny. OKF's permissive extension rule (producers MAY add frontmatter keys; consumers MUST preserve unknown keys) is the exact seam to inject MIF fields; the one tension is OKF's permissive-consumer model versus MIF's fail-closed validation. Against the prior art — Frictionless Data, JSON-LD and YAML-LD, schema.org, SKOS, PROV-O, RDF/OWL, and the Obsidian/Logseq/Roam PKM tools — none combines git-native authoring accessibility with typed, provenanced, and temporal depth. The Semantic Web's adoption failure and the consolidating RDF-star/PROV-O standards layer both argue for OKF+MIF's bet on pragmatic minimalism plus optional depth.
- Demand and market are favorable, with explicit statistical caveats. Hybrid graph-plus-vector (GraphRAG) is becoming the production default, agent memory's hardest unsolved problems are exactly staleness and provenance, and git-native markdown KM (Karpathy's LLM-wiki, Obsidian's 1.5M-plus users) is the practitioner trend OKF rides. The combined KM and enterprise-knowledge-graph TAM is large (about $25B in 2025). Weakened caveats — four market statistics that travel with the claim: the Gartner "80% of apps embed an AI agent by Q1 2026" figure is overstated against Gartner's own ~40%-by-end-2026 prediction; the "76% SaaS in 2025" a16z attribution could not be verified; and two AI-KM market-sizing growth rates ($7.71B at 47.2%; $4.2B to $36.5B) are soft, misattributed, and do not reconcile. The directional surges are real; the precise magnitudes are not load-bearing.

## Why It Matters

- The gap is the product. OKF's deliberate omissions are precisely the surface MIF fills, so the layered spine is a real, non-overlapping value-add rather than a reinvention.
- No spec-maturity risk on the MIF side. Because MIF is already at v1.0.0 RC and predates OKF, the modeling, provenance, and temporal layer is buildable today; the remaining work is integration and adoption, not standards invention.
- Defensible positioning. The clean feasibility seam plus the differentiation story put OKF+MIF in the unclaimed "structured but accessible" niche between thin PKM wikis and heavyweight graph databases.
- A funded buyer trajectory, to be read directionally. The pains (institutional-memory loss, LLM grounding, provenance tracking) are quantified and demand is rising, but pricing and TAM should be sized off the verified directional trend, not the four weakened headline figures. The decisive residual risk is OKF nascency: it has no ecosystem yet, and its minimalism may itself be the buyer preference.

## What's Next / Asks

- Decision: proceed with OKF as the packaging layer and MIF as the modeling, provenance, and temporal spine. Both thesis sub-questions — OKF's minimalism, and MIF's typed-relationship, provenance, and temporal advantage — are each backed by surviving findings.
- Owner, Spec/Eng: prototype the OKF-frontmatter-to-MIF-extension injection and resolve the permissive-consumer versus fail-closed-validation tension (define what a non-MIF-aware OKF consumer does when it encounters MIF fields).
- Owner, Strategy/GTM: validate the open-core model (free format, paid governance, hosting, and audit) against the verified directional demand; do not commit forecasts to the four weakened market statistics until they are re-sourced.
- Key risk to watch: OKF's minimalism may itself be the buyer preference, so MIF's richer layer must be opt-in and zero-friction or it is a solution without a segment. Input needed: at least one design partner that explicitly wants typed provenance.
- MIF's own gap is distribution and adoption — no large independent adopter base and governance still forming — so fund ecosystem and adoption work, not more spec work.
