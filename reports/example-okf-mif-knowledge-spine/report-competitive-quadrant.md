---
slug: reports/example-okf-mif-knowledge-spine/report-competitive-quadrant
version: 1
...
```mermaid
quadrantChart
    title Knowledge formats - semantic depth vs accessibility
    x-axis Low Semantic Depth --> High Semantic Depth
    ...
    "OKF+MIF": [0.82, 0.85]
    "PKM tools": [0.22, 0.80]
    "schema.org/JSON-LD": [0.40, 0.78]
    "Frictionless": [0.32, 0.69]
    "SKOS": [0.46, 0.36]
    "PROV-O": [0.72, 0.24]
    "RDF/OWL": [0.90, 0.18]
```
