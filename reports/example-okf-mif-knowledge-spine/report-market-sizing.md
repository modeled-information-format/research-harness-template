---
slug: reports/example-okf-mif-knowledge-spine/report-market-sizing
version: 1
...
```mermaid
flowchart TD
  TAM["TAM: KM software + enterprise KG, ~$25B-28B (2025)"]
  SAM["SAM: open, git-distributable knowledge infrastructure, ~$2.0B-3.3B"]
  SOM["SOM: technically sophisticated early adopters, ~$20M-60M (yr 1-3)"]
  TAM --> SAM --> SOM
```
